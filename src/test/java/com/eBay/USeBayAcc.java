...
public class USeBayAcc {
	
public static WebDriver driver;
	
	String browserName="chrome";
	@Test
	public void eBayUS( ) throws IOException {
			...
			File des = new File("D:\\Selenium\\eBay\\Screenshots\\PersonalAccUS.png");
			Files.copy(src,des );
			...
			File des1 = new File("D:\\Selenium\\eBay\\Screenshots\\BusinessAccUS.png");
