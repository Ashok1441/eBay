...
public class Accounts {
	...
	public void eBayLoginTest() throws InterruptedException, IOException {
	    ...
	    // clicking accounts options
		driver.findElement(By.xpath("(//li[@class='tab fake-tabs__item'])[2]")).click();
			
		//taking screenshot of obtain page   eBayscreenshot.jpg
		File src1 = ts.getScreenshotAs(OutputType.FILE);
		File des1 = new File("D:\\Selenium\\eBay\\Screenshots\\AccountScreenshot.jpg");
