...
public class PersonalAccount {
	...
	public void eBay(String browserName ) throws IOException {
			...
			File des = new File("D:\\Selenium\\eBay\\Screenshots\\FAQs.jpg");
			Files.copy(src,des );
			...
			File des1 = new File("D:\\Selenium\\eBay\\Screenshots\\Survey.jpg");
